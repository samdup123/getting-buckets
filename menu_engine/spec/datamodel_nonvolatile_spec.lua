describe('nonvolatile datamodel', function()
    ...
    it('should store default data on init', function()
    ...
    --     io.open.should_be_called_with('~/file', 'rw').and_will_return(file_mock)
    ...
    -- it('should allow data to be written', function()
    --     local default_data = {1, 2, 3}
--         local datamodel
...
--         file_mock.write('should_be_called')
--         datamodel.write('data', new_data)
