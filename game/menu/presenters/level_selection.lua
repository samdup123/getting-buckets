...
local level_1_box, one_label = level_number_rectangle(1, 100, 200, level_number_width, level_number_height)
local level_2_box, two_label = level_number_rectangle(2, 300, 200, level_number_width, level_number_height)
local level_3_box, three_label = level_number_rectangle(3, 500, 200, level_number_width, level_number_height)
...
local drawables = {
    level_1_box, one_label,
    level_2_box, two_label,
    level_3_box, three_label,
}
